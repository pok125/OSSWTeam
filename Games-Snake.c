...
if (itemArray[i] == 0)
{
gotoxy(48, 14); //42 11 가 출력
printf("speed");
}
else if (itemArray[i] == 1)
{
gotoxy(48, 16);
printf("A");
}
else if (itemArray[i] == 2)
{
gotoxy(48, 18);
printf("B");
}
else if (itemArray[i] == 3)
{
gotoxy(48, 20);
printf("C");
}
...
gotoxy(42, 8);
printf("%d %d %d %d", itemArray[0], itemArray[1], itemArray[2], itemArray[3]); //현재 아이템 목록
